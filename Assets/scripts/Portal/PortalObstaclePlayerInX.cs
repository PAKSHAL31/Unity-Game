...
public class PortalObstaclePlayerInX : MonoBehaviour
{
    ...
    {
        if (((ypos + 1) != yobs1p || xpos != xobs1p) && ((ypos + 1) != yobs2p || xpos != xobs2p) && ((ypos + 1) != yport || xpos != xport))
        {
            if (ypos < y)
            {
    ...
    {
        if (((xpos - 1) != xobs1p || ypos != yobs1p) && ((xpos - 1) != xobs2p || ypos != yobs2p))
        {
            if (xpos > 0)
            {
